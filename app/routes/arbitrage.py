...
@router.get("")
async def arbitrage(collection: list[str] = Query(default=[]), min_profit_ton: Decimal = Query(default=Decimal("0"), ge=0), min_profit_percent: Decimal = Query(default=Decimal("0"), ge=0), getgems_fee_percent: Decimal = Query(default=Decimal("2"), ge=0, lt=100), portals_fee_percent: Decimal = Query(default=Decimal("0"), ge=0, lt=100), fragment_fee_percent: Decimal = Query(default=Decimal("0"), ge=0, lt=100)):
