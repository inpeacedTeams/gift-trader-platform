        ...
        for wallet in wallets:
            try:
                ...
                for item in nft_items:
                    ...
                    holding.collection_address = collection_address or holding.collection_address; holding.name = metadata.get("name") or holding.name; holding.image_url = metadata.get("image") or holding.image_url; holding.estimated_price_ton = price; holding.valuation_source = source; holding.valuation_confidence = confidence; holding.observed_at = datetime.now(timezone.utc); holdings_count += 1
