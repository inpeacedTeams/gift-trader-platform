...
const TITLES: Record<View, string> = { overview: "Market overview", gifts: "Gifts", opportunities: "Opportunities", watchlist: "Watchlist", portfolio: "Portfolio", alerts: "Alerts", settings: "Settings" };
...
export default function App() {
  ...
  const changeView = (next: View) => { setSelectedGift(null); setView(next); };
  const opportunities = arbitrage?.opportunities ?? [];
  const page = view === "gifts"
    ? (selectedGift === null ? <Gifts onOpen={setSelectedGift}/> : <GiftPage giftId={selectedGift} onBack={() => setSelectedGift(null)}/>)
